...
EOF
    ...
    {
        $converter = $this->converter();
        $result = $converter->convertToHtml('This is **pretty normal**');
        $this->assertEquals("<p>This is <strong>pretty normal</strong></p>\n", $result);
        $result = $converter->convertToHtml('This seems **a bit strict **');
        $this->assertEquals("<p>This seems **a bit strict **</p>\n", $result);
    }
}
